...
import { CreateTopicDto, GetCancelRegisteredTopicResponseDto, GetTopicResponseDto } from '../dtos'
...
export interface TopicRepositoryInterface extends BaseRepositoryInterface<Topic> {
    ...
    findCanceledRegisteredTopicsByUserId(userId: string, userRole: string): Promise<GetCancelRegisteredTopicResponseDto[]>
}
